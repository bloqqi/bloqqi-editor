...
public class PageFeatures extends AbstractWizardPage  {
	...
	private static final String PAGE_NAME = "FEATURES_SELECT_FEATURES";
	...
	public PageFeatures() {
		super(PAGE_NAME);
		setTitle("Specialize block with features");
	}
	...
	protected void createSuperTypeUI() {
		new Label(container, SWT.NONE).setText("Base diagram:");
	...
	protected void createRecommendedBlocksUI() {
		...
		treeViewer.setLabelProvider(new FeatureTableLabelProvider());
