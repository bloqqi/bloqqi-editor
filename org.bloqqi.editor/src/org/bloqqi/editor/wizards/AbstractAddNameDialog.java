...
public abstract class AbstractAddNameDialog extends Dialog {
	...
	public AbstractAddNameDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected void createFields(Composite container) {
		...
		createTypeField(container);
	}

	protected void createNameField(Composite container) {
	...
	protected void createTypeField(Composite container) {
